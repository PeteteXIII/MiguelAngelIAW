...
<div id="page" class="site">
    <div class="<?php if(get_theme_mod('mobile_repair_zone_site_width_layout','Full Width') == 'Wide Width'){?>container-fluid<?php } elseif(get_theme_mod('mobile_repair_zone_site_width_layout','Full Width') == 'Container Width') {?>container<?php }?>">
